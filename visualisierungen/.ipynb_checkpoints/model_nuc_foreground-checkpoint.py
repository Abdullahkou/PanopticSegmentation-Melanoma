...
class HalfDualDecUNetPlusPlus(nn.Module):
    def __init__(self, num_classes=4,in_channel=4, att=True):
...
class HalfDualDecUNetPlusPlusD4(nn.Module):
    def __init__(self, num_classes=4, in_channel=4):
        super(HalfDualDecUNetPlusPlusD4, self).__init__()
        self.num_classes = num_classes
        self.in_channel = in_channel
        ...
        unetplusplus_tissue = UnetPlusPlus(
            ...
            classes=self.num_classes,          # Anzahl der Klassen
            activation=None,                   # Keine Aktivierungsfunktion am Ende
            encoder_depth=4,                   # Begrenze die Tiefe des Encoders
