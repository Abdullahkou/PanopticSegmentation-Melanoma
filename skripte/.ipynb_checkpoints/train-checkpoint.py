...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', type=str, default="TSG",
    ...
    training_data = TissueSegmentationDataset(
        train_df
    )
    ...
    #     stopper = early_stopping.EarlyStopper(best,
    #                                           patience=epochs,
    #                                           criterion='max')
    #     early_stopper_list.append(stopper)

    # Freeze the pre-trained encoder for the first 5 epochs
