...
from model_foreground import HalfDualDecUNetPlusPlus
...
import random
import set_seed
from dataset_foreground import ForegroundSegmentationDataset
...
if __name__ == "__main__":
    ...
    training_data = ForegroundSegmentationDataset(
        train_df,
    ...
    validation_data = ForegroundSegmentationDataset(
        val_df,
        add_gray_channel=True, 
        ttrain = False
    )
