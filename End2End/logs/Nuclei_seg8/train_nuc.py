...
if __name__ == "__main__":
    ...
    model = HalfDualDecUNetPlusPlus(in_channel= 8)
    # state_dict = torch.load(weights_path)
    # model.load_state_dict(state_dict, strict=False)
    model.to(device)

    model_1 = HalfDualDecUNetPlusPlus(in_channel=4)
    model_1.load_state_dict(torch.load(r"../skripte/logs/Nuclei_seg33/best_f1.pt"))
